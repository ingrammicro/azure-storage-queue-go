...
func (s *queueSuite) TestRetryTestScenarioUntilSuccess(c *chk.C) {
	testRetryTestScenario(c, retryTestScenarioRetryUntilSuccess)
}

func (s *queueSuite) TestRetryTestScenarioUntilOperationCancel(c *chk.C) {
	testRetryTestScenario(c, retryTestScenarioRetryUntilOperationCancel)
}
func (s *queueSuite) TestRetryTestScenarioUntilMaxRetries(c *chk.C) {
...
func testRetryTestScenario(c *chk.C, scenario retryTestScenario) {
	...
	retryOptions := azqueue.RetryOptions{
